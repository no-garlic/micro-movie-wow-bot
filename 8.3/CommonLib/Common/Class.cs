...
namespace CommonLib
{
    public abstract class ClassBase
    {
        ...
        public CI           ClassInfo   { get { return m_ClassInfo; } }
        public PET          PetInfo     { get { return m_PetInfo; } }
        ...
        public bool AreMagicNumbersValid()
        {
            if (Config.IgnoreDataChecks)
                return true;

            if (m_MagicNumberA.IsValid == false || m_MagicNumberB.IsValid == false)
                return false;
